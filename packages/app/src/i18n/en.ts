export const dict = {
  ...
  "dialog.server.status.serving": "Serving",
  "dialog.server.inbound.title": "Local server",
  "dialog.server.inbound.restartRequired": "Restart OpenCode to apply changes",
  "dialog.server.inbound.access.title": "Allow remote access",
  "dialog.server.inbound.access.description": "Allow remote OpenCode clients to connect to this machine",
  ...
  "dialog.server.inbound.credentialInvalid": "Credentials do not match the running server. Check the username and password.",
  ...
  "error.page.auth.description":
    "This server requires a password. Open this page from the OpenCode desktop app, or use a link with an auth token.",
  "error.page.auth.action.home": "Back home",
