...
export const dict = {
  ...
  "dialog.server.menu.settings": "設定",
  ...
  "dialog.server.status.serving": "開放",
  "dialog.server.inbound.title": "本機伺服器",
  "dialog.server.inbound.restartRequired": "重新啟動 OpenCode 後才會生效",
  "dialog.server.inbound.access.title": "開放遠端存取",
  "dialog.server.inbound.access.description": "允許遠端 OpenCode 用戶端連線到這台機器",
  "dialog.server.inbound.username": "使用者名稱（選填）",
  "dialog.server.inbound.usernamePlaceholder": "使用者名稱",
  "dialog.server.inbound.password": "密碼（選填）",
  "dialog.server.inbound.passwordPlaceholder": "密碼",
  "dialog.server.inbound.port": "連接埠",
  "dialog.server.inbound.portPlaceholder": "連接埠",
  "dialog.server.inbound.portRequired": "請輸入連接埠",
  "dialog.server.inbound.portInvalid": "請輸入 1 到 65535 之間的連接埠",
