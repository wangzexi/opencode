...
export const dict = {
  ...
  "dialog.server.menu.settings": "设置",
  ...
  "dialog.server.status.serving": "开放",
  "dialog.server.inbound.title": "本地服务器",
  "dialog.server.inbound.restartRequired": "重启 OpenCode 后才会生效",
  "dialog.server.inbound.access.title": "开放远程访问",
  "dialog.server.inbound.access.description": "允许远程 OpenCode 客户端连接到这台机器",
  "dialog.server.inbound.username": "用户名（可选）",
  "dialog.server.inbound.usernamePlaceholder": "用户名",
  "dialog.server.inbound.password": "密码（可选）",
  "dialog.server.inbound.passwordPlaceholder": "密码",
  "dialog.server.inbound.port": "端口",
